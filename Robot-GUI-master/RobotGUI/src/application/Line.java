...
public class Line  {
	...
	/**
	 * Returns true if this line segment intersects a circle 
	 * whose center is (cx, cy) and radius is r.
	 */
	public boolean intersectsCircle(double cx, double cy, double r) {
	    // Extract endpoints (x1,y1),(x2,y2) from your coords array
	    double x1 = coords[0];
	    double y1 = coords[1];
	    double x2 = coords[2];
	    double y2 = coords[3];
	    ...
	    // Possibly 1 or 2 intersections
	    discriminant = Math.sqrt(discriminant);
	    double t1 = (-b - discriminant) / (2*a);
	    double t2 = (-b + discriminant) / (2*a);

	    // If either t is within [0,1], the segment intersects the circle
	...
	public double[] getCoords() {
	    // if coords is private double[] {x1, y1, x2, y2}
	    return coords;
	}
